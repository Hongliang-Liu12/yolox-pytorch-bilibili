...
class YOLO_MAP:
    def __init__(self, classes_path, phi, model_path, input_shape=[640, 640], confidence=0.01, nms_iou=0.6, 
    ...
    def detect_image(self, image, image_id):
        ...
        with torch.no_grad():
            ...
            # print("NMS后输出的数组形状：", results[0].shape)
            # print("NMS后输出的前5个结果：", results[0][:5])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='/home/lhl/Git/yolox-pytorch-bilibili/yolox_only_weights.pth', help='模型权重文件路径')
