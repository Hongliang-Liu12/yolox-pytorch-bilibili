...
class YOLO(object):
    _defaults = {
        ...
        "classes_path"      : 'model_data/event_classes.txt',
        #---------------------------------------------------------------------#
        #   输入图片的大小，必须为32的倍数。
        #---------------------------------------------------------------------#
        "input_shape"       : [640, 640],
    ...
    def detect_image(self, image):
        ...
        with torch.no_grad():
            ...
            #DEBUG
            print("DEBUG:Model outputs:", outputs)
            #DEBUG
        ...
        for i, c in list(enumerate(top_label)):
            ...
            l, t, r, b = draw.textbbox((0, 0), label, font)
            w, h = r - l, b - t
            label_size = [w, h]
